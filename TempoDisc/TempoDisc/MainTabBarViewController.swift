...
class MainTabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let selectedImages = [#imageLiteral(resourceName: "DevicesActive"), #imageLiteral(resourceName: "HistoryActive"), #imageLiteral(resourceName: "GlossaryActive")]
        let images = [#imageLiteral(resourceName: "DevicesInactive"), #imageLiteral(resourceName: "HistoryInactive"), #imageLiteral(resourceName: "GlossaryInactive")]
        var i = 0
